...
import PhotoAlbumClient from '@/components/photo-album-client';

export const metadata: Metadata = {
  title: 'Photo Album - Bharat Bang',
      ...
      <header className="py-6 animated-header-background text-primary-foreground shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-semibold tracking-tight">Photo Album</h1>
