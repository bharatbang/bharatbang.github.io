...
import CarSearchClient from '@/components/car-search/car-search-client';

export const metadata: Metadata = {
  title: 'Search New Cars - Bharat Bang',
  description: 'Find new cars in India by budget, body type, fuel type, and more.',
};
      ...
      <header className="py-6 animated-header-background text-primary-foreground shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-semibold tracking-tight">New Cars in India</h1>
