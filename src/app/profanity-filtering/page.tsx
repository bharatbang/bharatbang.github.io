...
import ProfanityFilteringClient from '@/components/profanity-filtering-client';

export const metadata: Metadata = {
  title: 'Profanity Filtering - Bharat Bang',
  description: 'Test profanity filtering in a text area.',
};

export default function ProfanityFilteringPage() {
  return (
      ...
      <header className="py-6 animated-header-background text-primary-foreground shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-semibold tracking-tight">Profanity Filtering</h1>
